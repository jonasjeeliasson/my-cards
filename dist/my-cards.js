 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,i){const o=e[0];if("."===o){return new V(t,e.slice(1),n).parts}if("@"===o)return[new Y(t,e.slice(1),i.eventContext)];if("?"===o)return[new D(t,e.slice(1),n)];return new M(t,e,n).parts}handleTextExpression(t){return new A(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
